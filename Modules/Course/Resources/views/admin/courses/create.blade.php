...
@section('content-header')
    <h1>
        {{ trans('course::courses.title.create course') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.course.course.index') }}">{{ trans('course::courses.title.courses') }}</a></li>
        <li class="active">{{ trans('course::courses.title.create course') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.course.course.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
